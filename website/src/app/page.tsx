    ...
    <main>
      ...
      >
        ...
        <header className="relative z-10 flex items-center justify-between px-8 py-6">
          <div className="flex items-center gap-2">
            ...
            <span className="font-display font-bold text-xl" style={{ color: '#1a3d12' }}>
              Checked.
            </span>
          </div>
          <a
        ...
        <div className="relative z-10 flex flex-1 flex-col items-center justify-center text-center px-6 pb-20">
          ...
          >
            A beautifully simple app for checklists and notes — with four gorgeous themes that adapt
            to your mood.
          </p>
      ...
      >
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-8 py-20 w-full">
          <div className="mb-16">
            ...
            <p className="text-lg max-w-md leading-relaxed" style={{ color: '#7A523099' }}>
              Checked strips away complexity. Just your tasks, your notes, your way.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              >
                ...
                <h3 className="font-display font-bold text-xl mb-2" style={{ color: '#3d2010' }}>
                  {f.title}
                </h3>
                <p className="text-sm leading-relaxed" style={{ color: '#7A5230' }}>
                  {f.desc}
                </p>
              </div>
            ))}
      ...
      >
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-8 py-20 w-full">
          <div className="mb-12 flex items-center gap-3">
            ...
            <div>
              <h2 className="font-display text-5xl font-black" style={{ color: '#4d0f0f' }}>
                What&apos;s New
              </h2>
                ...
                >
                  ...
                  <ul className="px-5 py-4 space-y-2">
                    ...
                    {parseHighlights(release.body).length === 0 && (
                      <li className="text-sm italic" style={{ color: '#FF6B6B80' }}>
                        No release notes.
                      </li>
                    )}
                  </ul>
      ...
      >
        ...
        <div className="relative z-10 flex flex-1 flex-col items-center justify-center text-center px-6 py-20">
          ...
          <p className="text-lg max-w-md mb-12 leading-relaxed" style={{ color: '#9333ea60' }}>
            Download Checked today and never let another task, idea, or thought slip away.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-20">
            <a
              ...
              style={{ backgroundColor: '#C77DFF', boxShadow: '0 8px 32px #C77DFF40' }}
            >
              <Smartphone size={20} className="group-hover:-translate-y-0.5 transition-transform" />
              Download APK
            </a>
          ...
          <div className="flex gap-4 mb-20">
            {[
              ...
              { color: '#C77DFF', bg: '#FAF5FF', emoji: '🪻', name: 'Lavender' },
            ].map(t => (
              <div
                key={t.name}
                ...
                style={{ backgroundColor: t.bg, border: `2px solid ${t.color}30` }}
              >
                <div
        ...
        >
          <div className="flex items-center gap-1.5 text-sm" style={{ color: '#9333ea80' }}>
            <span>Created with</span>
            <Heart size={14} className="fill-current" style={{ color: '#FF6B6B' }} />
            <span>by</span>
            <a
          ...
          <div className="flex items-center gap-6 text-sm" style={{ color: '#9333ea60' }}>
            <Link
              href="/privacy"
  ...
  const updates = [
    {
      version: 'v0.1.2-beta',
      date: 'March 2026',
      highlights: ['Complete UI redesign', 'Theme Customization', 'Notes support'],
      latest: true,
    },
    {
      version: 'v0.1.1-beta',
    ...
    <div className="space-y-5">
      {updates.map((u, i) => (
        ...
        >
          ...
          >
            <Tag size={14} color={i === 0 ? 'white' : '#FF6B6B'} />
            <span className="font-bold text-sm" style={{ color: i === 0 ? 'white' : '#FF6B6B' }}>
              {u.version}
            </span>
            {u.latest && (
              <span className="ml-auto text-xs bg-white/20 text-white px-2 py-0.5 rounded-full font-semibold">
          ...
          <ul className="px-5 py-4 space-y-2">
            {u.highlights.map((h, idx) => (
              <li key={idx} className="flex items-start gap-2.5 text-sm">
                <ArrowRight size={14} className="mt-0.5 shrink-0" style={{ color: '#FF6B6B' }} />
                <span style={{ color: '#4d0f0f' }}>{h}</span>
              </li>
            ))}
          </ul>
